  ...
  <div class="bg-st-grey">
    ...
    <div class="grid grid-cols-4 gap-5 mt-10">
      <div v-for="(item, index) in computedRecomended"
        class="drop-shadow-2xl bg-white group hover:cursor-pointer hover:bg-st-blue transition-all rounded-3xl px-4 pt-7 pb-20 flex flex-col gap-10 relative" @click="myRouter.push('/problem/do-problem/'+item.id)">
