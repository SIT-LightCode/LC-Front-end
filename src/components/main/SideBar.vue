		...
		<div class="card flex justify-content-center ">
			...
			<div class="font-roboto text-lg flex flex-col mt-10 justify-center items-center w-44 ">
				<div v-if="user.authorities == 'ADMIN'" class="flex flex-col w-full border-b-2 ">
					...
					:class="[$route.path == '/view-user/list'? 'text-st-blue border-l-blue-600':'']"
				...
				<div class="flex flex-col w-full  border-b-2">
					...
					<div class="flex flex-col  ">
						...
						:class="[$route.path == '/lightcode'? 'text-st-blue border-l-blue-600':'']"
						...
						:class="[$route.path.startsWith('/learning/list') ? 'text-st-blue border-l-blue-600':'']"
						...
						:class="[$route.path == '/problem/list'? 'text-st-blue border-l-blue-600':'']"
						...
						:class="[$route.path == '/myproblem/list'? 'text-st-blue border-l-blue-600':'']"
